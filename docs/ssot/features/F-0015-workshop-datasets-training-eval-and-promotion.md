...
- Verification:
  ...
  - `dossier-engineer coverage-audit --dossier docs/ssot/features/F-0015-workshop-datasets-training-eval-and-promotion.md --orphans-scope=dossier`
  - `dossier-engineer contract-drift-audit --dossier docs/ssot/features/F-0015-workshop-datasets-training-eval-and-promotion.md --base HEAD~1`
  - `dossier-engineer dossier-verify --dossier docs/ssot/features/F-0015-workshop-datasets-training-eval-and-promotion.md --step implementation`
- Issue: none
- PRs: none
- Process artifacts:
