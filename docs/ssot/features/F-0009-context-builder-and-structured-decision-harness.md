...
- `docs/notes/backlog-legacy/feature-candidates.md`, `docs/ssot/index.md` and architecture coverage map stay aligned on this feature’s owner and status.
...
- Verification:
  ...
  - `dossier-engineer coverage-audit --dossier docs/ssot/features/F-0009-context-builder-and-structured-decision-harness.md`
