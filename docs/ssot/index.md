...
_Last sync: 2026-04-10T19:01:51.552Z_
...
| F-0017 | Git-управляемая эволюция тела и стабильные снапшоты | in_progress | deferred | body | F-0001, F-0002, F-0010, F-0015, F-0016 | runtime,db,governance,workspace,tooling,recovery | `../features/F-0017-git-managed-body-evolution-and-stable-snapshots.md` |
