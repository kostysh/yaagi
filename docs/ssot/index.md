...
_Last sync: 2026-04-29T10:21:27.577Z_
...
| F-0028 | Support / operability contract и incident discipline | proposed | deferred | operations | F-0013, F-0023, F-0024, F-0026 | operations,support,incident-response,observability,release | `features/F-0028-support-operability-contract-incident-discipline.md` |
...
- **WARN** F-0028 — No acceptance criteria IDs found yet. Add at least one AC-F....-.. entry before leaving the proposed intake state.
- **WARN** F-0028 — Coverage map rows are recommended even when coverage is deferred.
