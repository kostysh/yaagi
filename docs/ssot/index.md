...
_Last sync: 2026-03-25T16:59:11.394Z_
...
| F-0002 | Канонический scaffold монорепы и deployment cell | planned | strict | platform | — | runtime,infra,db,models,workspace | `../features/F-0002-canonical-monorepo-deployment-cell.md` |
...
| F-0006 | Актуализация базовых зависимостей и выравнивание инструментального стека | planned | strict | platform | F-0001, F-0002, F-0003, F-0004, F-0005 | runtime,infra,toolchain,dependencies | `../features/F-0006-baseline-dependency-refresh-and-toolchain-alignment.md` |
...
| F-0009 | Context Builder и structured decision harness | planned | strict | cognition | F-0003, F-0004, F-0005, F-0008 | runtime,db,perception,memory,models,cognition | `../features/F-0009-context-builder-and-structured-decision-harness.md` |
