...
_Last sync: 2026-04-10T00:34:01.766Z_
...
| F-0016 | Development Governor и управление изменениями | proposed | deferred | governance | F-0004, F-0011, F-0012 | runtime,db,governance,api,models,workspace,workshop | `../features/F-0016-development-governor-and-change-management.md` |
...
- **WARN** F-0013 — Change log shows mature replanning, but no short reason tags were found. Prefer tags like `[clarification]`, `[scope realignment]`, `[dependency realignment]`, `[risk discovery]`, or `[contract drift]`.
...
- **WARN** F-0016 — Potential compound ACs detected: AC-F0016-01, AC-F0016-02, AC-F0016-03, AC-F0016-04, AC-F0016-01, AC-F0016-03, AC-F0016-04. Prefer one obligation per AC.
