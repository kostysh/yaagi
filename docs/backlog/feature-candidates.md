...
| CF-002 | Тиковый runtime, scheduler и эпизодическая линия времени | рантайм | candidate | CF-001, CF-020 | Система становится "живой" только тогда, когда существуют тики, scheduler/lease discipline, эпизоды и одна субъективная линия времени (`3.1`, `3.2.A`, `4.2.2`, `9.2`, Phase 0). | - |
