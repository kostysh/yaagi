...
| Workshop training/eval/promotion pipeline | `F-0015` | `shaped` | Workshop now has a decision-complete shaped owner: datasets, training/eval lineage, full candidate lifecycle semantics and bounded promotion-package projection are fixed, while approval/activation overlays remain future-owned. |
