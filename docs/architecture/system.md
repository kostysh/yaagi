...
| Workshop training/eval/promotion pipeline | `F-0015` | `planned` | Workshop delivery is now implementation-ready: ordered slices cover datasets, training/eval lineage, full candidate lifecycle semantics and bounded promotion-package projection, while approval/activation overlays remain future-owned. |
