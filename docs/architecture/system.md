...
| Skills procedural layer and package boundary | `F-0022` / `CF-013` | `shaped` | Canonical dossier now owns repo-based skill packaging, `seed/skills` vs `workspace/skills` boundary and adapter-loaded usable-skill proof; implementation and delivery remain future work. |
