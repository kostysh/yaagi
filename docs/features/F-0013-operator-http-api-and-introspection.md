...
- Verification:
  ...
  - `dossier-engineer contract-drift-audit --dossier docs/features/F-0013-operator-http-api-and-introspection.md --base HEAD~1`
  - `dossier-engineer lint-dossiers`
  - `dossier-engineer coverage-audit --dossier docs/features/F-0013-operator-http-api-and-introspection.md --orphans-scope=dossier`
  - `dossier-engineer debt-audit --changed-only`
  - `dossier-engineer dossier-verify --dossier docs/features/F-0013-operator-http-api-and-introspection.md --step implementation`
