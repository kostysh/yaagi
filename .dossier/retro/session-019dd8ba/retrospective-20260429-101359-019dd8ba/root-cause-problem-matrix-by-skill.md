...
2. `dossier-engineer dossier-verify`: machine-check repository-declared verification profile для code-bearing protected/side-effect implementation.
3. `unified-dossier-engineer`: добавить dossier-specific remediation note после второго blocking audit FAIL в одном structured dossier risk family.
